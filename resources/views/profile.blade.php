...
<style>
    .slider{
        height: 400px;
        width: 100%;
        background-image: url({{URL::asset('storage/tag/default.jpg')}});
        ...
        <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                ...
                                <div class="blog-image"><img src="{{URL::asset('storage/post/'.$post->image)}}"
                                        alt="{{$post->title}}"></div>

                                <a class="avatar" href="{{route('post.details',$post->slug)}}"><img src="{{URL::asset('storage/profile/'.$post->user->image)}}" alt="Profile Image"></a>
                        ...
                        <div class="card h-100">
                            <div class="single-post post-style-1">
                                <div class="blog-info">
                                    <h4 class="title">
                                        <strong>
                                            <h3>Sorry, the author doesn't have any post</h3>
                                        </strong>
                                    </h4>
                                </div>
                            </div>
            ...
            <div class="col-lg-4 col-md-12 ">
                ...
                <div class="single-post info-area ">
                    ...
                    <p>{{$author->about}}</p>
                    <br>
                    <strong>Author since : {{$author->created_at->format('d-m-Y')}}</strong>
                    <br>
                    <strong>Total posts : <span class="badge bg-success">{{$author->posts->count()}}</span></strong>
                    </div>
